...
def inception1b(in_tensor):
	...
	tpool = Conv2D(64, (1, 1), padding='same')(tpool)
	tpool = BatchNormalization()(tpool)
	tpool = Activation('relu')(tpool)
...
def inception1c(in_tensor):
	t3 = Conv2D(128, (1, 1), padding='same')(in_tensor)
	t3 = BatchNormalization()(t3)
	t3 = Activation('relu')(t3)
	t3 = Conv2D(256, (3, 3), padding='same', strides=(2, 2))(t3)
	t3 = BatchNormalization()(t3)
	t3 = Activation('relu')(t3)
	...
	t5 = BatchNormalization()(t5)
	t5 = Activation('relu')(t5)
	t5 = Conv2D(64, (5, 5), padding='same', strides=(2, 2))(t5)
	t5 = BatchNormalization()(t5)
	t5 = Activation('relu')(t5)
	
	tpool = MaxPooling2D(pool_size=(3, 3), padding='same', strides=(2, 2))(in_tensor)
	tpool = Conv2D(32, (1, 1), padding='same')(tpool)
	tpool = BatchNormalization()(tpool)
	tpool = Activation('relu')(tpool)
	...
	t1 = Activation('relu')(t1)
	'''
	output = concatenate([t3, t5, tpool])
	return output
...
def inception2b(in_tensor):
	t3 = Conv2D(160, (1, 1), padding='same')(in_tensor)
	t3 = BatchNormalization()(t3)
	t3 = Activation('relu')(t3)
	t3 = Conv2D(256, (3, 3), padding='same', strides=(2, 2))(t3)
	t3 = BatchNormalization()(t3)
	...
	t5 = Conv2D(64, (1, 1), padding='same')(in_tensor)
	t5 = BatchNormalization()(t5)
	t5 = Activation('relu')(t5)
	t5 = Conv2D(128, (5, 5), padding='same', strides=(2, 2))(t5)
	t5 = BatchNormalization()(t5)
	t5 = Activation('relu')(t5)
...
def AFC(in_tensor):
	out = AveragePooling2D(pool_size=(2, 2), strides=(1, 1))(in_tensor)
	out = Flatten()(out)
